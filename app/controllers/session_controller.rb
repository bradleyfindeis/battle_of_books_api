class SessionController < ApplicationController
  ...
  def check
    ...
    # ── User session ──
    user = current_user_from_cookie || refresh_user_session!
    if user
      team = user.team
    ...
    # ── Admin session ──
    admin = current_admin_from_cookie || refresh_admin_session!
    result[:admin] = { id: admin.id, email: admin.email } if admin
