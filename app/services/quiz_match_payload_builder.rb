...
class QuizMatchPayloadBuilder
  def self.build(match)
    ...
    payload = {
      ...
      challenger_avatar_color: match.challenger.avatar_color,
      ...
      invited_opponent_avatar_color: match.invited_opponent.avatar_color,
      opponent_id: match.opponent_id,
      opponent_username: match.opponent&.username,
      opponent_avatar: match.opponent&.avatar_emoji,
      opponent_avatar_color: match.opponent&.avatar_color,
